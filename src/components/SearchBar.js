              ...
              <div className='col-md-8 col-md-offset-2 intro-text'>
                ...
                <br />
                  ...
                  The internet’s source of images.
                    Powered by NASAIAN everywhere
                  </span>
                </h1>
                                <Form onSubmit={handleSubmit}>
                                    <Form.Group className="mb-3" >
                                        <Form.Control type="text" placeholder="What you want to Saerch ..." 
                                        value ={Search}
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="11" fill="currentColor" class="bi bi-search-heart" viewBox="0 0 16 16">
